...
public class RegionUtils {
     ...
     */
    public List<Block> getRegionBlocks(World world, Location pos1, Location pos2) {
     ...
     */
    public List<Block> findBlocksInRegion(World world, Location pos1, Location pos2, Material query) {
     ...
     * @return a list of every block that matches the query in the region
     */
    public List<Block> findBlocksInRegion(World world, Location pos1, Location pos2, List<Material> query) {
        List<Block> blocks = getRegionBlocks(world, pos1, pos2);
     ...
     */
    public List<Block> findBlocksInList(List<Block> search, List<Material> query) {
